        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h2 class="main__logo--title"><a>Главная</a></h2>
                </div>                                                          
            </div>
        </div>
    </div>
...
<form action="/courier/show" method="post">
    <button type="submit" style="width:200px;height:50px" class="primary__btn price__filter--btn">Расписание</button>
</form>
</br>

<form action="/courier/add" method="post">
    <button type="submit" style="width:200px;height:50px" class="primary__btn price__filter--btn">Добавление</button>
</form>
</br>

<form action="/courier/script" method="post">
    <button type="submit" style="width:200px;height:50px" class="primary__btn price__filter--btn">Скрипт!</button>
</form>
</br>
